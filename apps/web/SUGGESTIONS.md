...
### 1. Alpha modifiers on theme colors compile to nothing
...
### 2. Dark-mode borders render as light gray-200
...
### 3. Dark `--muted-foreground` fails WCAG AA
...
### 16. Selection affordance is one weak tint
