...
/** `schema/table` lookup key for the per-table maps the F123 batched queries below group into. */
 ...
 * round trip per query across every table instead of one trio per table. */
