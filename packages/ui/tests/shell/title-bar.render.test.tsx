...
const baseProps = {
  ...
  target: "postgres://postgres:***@localhost:5432/qyre_test",
  theme: "dark" as const,
  onToggleTheme: vi.fn(),
  onRefresh: vi.fn(),
...
describe("TitleBar", () => {
  ...
  it("keeps the status text in the accessibility tree without a visible header dot", () => {
    render(<TitleBar {...baseProps} />);
    expect(screen.getByTestId("status-badge").querySelector(".rounded-full")).toBeNull();
